...
/**
   ...
   @OSPProject Threads
*/
public class ThreadCB extends IflThreadCB implements PriorityItemInterface
{
    ...
    */
    static public ThreadCB do_create(TaskCB task)
    {
        ...
        int addStatus = task.addThread(newThread);
        if (addStatus == FAILURE){
            dispatch();
            return null;
        }
        int taskPrio = task.getPriority();
        newThread.setPriority(taskPrio);
    ...
    */
    public void do_kill()
    {
        ...
        for (int a = 0; a < Device.getTableSize(); a++){
            Device.get(a).cancelPendingIO(this);
        }
        ResourceCB.giveupResources(this);
        int threadRemoval = this.getTask().removeThread(this);
        if (threadRemoval == FAILURE){
            return;
        }
    ...
    public static int do_dispatch()
    {
        ...
        if (MMU.getPTBR() == null){
            if (readyQueue.isEmpty()) {
                ...
                currentThread = (ThreadCB)readyQueue.removeHead();
   ...
   public String toString()
    {
        ...
        return ("Thread("+threadId+":"+taskId+"/"+printableShortStatus(status)+";"+priority+")");
    }
